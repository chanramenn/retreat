...
const RetreatPrograms = () => {
  const upcomingRetreats = [
    {
      id: 1,
      title: "Ближайшие ретриты в этом году состоятся в Крыму!",
      dates: (
  <>
    21.06–25.06 <br /> 29.07–02.08 <br />
  </>
),
      duration: (
  <>
    5 дней <br /> Запись по номеру телефона +7 (985)000-75-77
  </>
),
  ...
  <>
    Сентябрь 2026 <br />  
      ...
      duration: (
  <>
    1 день <br /> Запись по номеру телефона +7 (985)000-75-77 <br />  <br /> 
  </>
),
